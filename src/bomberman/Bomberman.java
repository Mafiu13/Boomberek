...
// naciśnięcie klawisza skutkuje ruchem b1, coś podobnego dla b2 tylko z drugiego watku od klienta trzeba pobierac info
    public void keyPressed(KeyEvent e) 
    {
      b1.keyPressed(e);
      b2.keyPressed(e);
      System.out.println(b2.getIleBomb());
 //    bomb.keyPressed(e);
       //for(int j=0;j<bombs.size();j++)
                  {
                 //     Actors b = (Actors)bombs.get(b2.getIleBomb());
                  //    b.keyPressed(e);
                      bomb1.keyPressed(e);
                      bomb2.keyPressed(e);
        ...
        //      bomb=new Bomb(this);
          ...
          bomb2.setY((int) Board.HEIGHT+90);
              ...
              //    for(int i=0;i<50;i++)
                ...
                //      b.setX((int)Board.WIDTH+40);
                 //     b.setY((int) Board.HEIGHT+90);
                  //    bombs.add(b);
                  }
       ...
       if (startTimer2==false)
        {
             ...
             g.setPaint(Color.green);
                g.drawString("WARTOŚĆ POLA RAŻENIA WYNOSI "+CriticalRange,0,50);
                     ...
                     System.out.println("powinno działac");
        }
